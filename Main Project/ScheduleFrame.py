...
class ScheduleFrame:
    ...
    def __init__(self, root, motherFrame, homeScreen, staticAppInfo):
        ...
        #Create canvas frame
        self._scheduleCanvasFrame = tk.Frame(self._motherFrame, background=self._staticAppInfo.getColor(self._frameDescriptor))
        self._scheduleCanvasFrame.place(relwidth = 1, relheight = 1)

        #Create canvas and scrollbar in canvas frame
        self._scheduleCanvas = tk.Canvas(self._scheduleCanvasFrame, background=self._staticAppInfo.getColor(self._frameDescriptor))
        ...
        self._scheduleFrame = tk.Frame(self._scheduleCanvas, background=self._staticAppInfo.getColor(self._frameDescriptor))
        ...
        #Frame
        bottomFrame = tk.Frame(self._scheduleFrame, background=self._staticAppInfo.getColor(self._frameDescriptor))
        #Back button
        ...
        self._titleStandFrame = EventFrame(self._scheduleFrame,
                                           row=0,
                                           ...
                                           titleFont="title")
        #Up stand frame
        self._upStandFrame = EventFrame(self._scheduleFrame,
                                        row = 1,
                                        root = root,
                                        staticAppInfo=self._staticAppInfo,
                                        titleFont="standard",
        ...
        self._downStandFrame = EventFrame(self._scheduleFrame,
                                          row=2,
                                          titleFont="standard",
                                          staticAppInfo=self._staticAppInfo,
                                          frameDescriptor=self._frameDescriptor,
        ...
        self._timelyDownStandFrame = EventFrame(self._scheduleFrame,
                                                row = 3,
                                                staticAppInfo=self._staticAppInfo,
                                                root=root,
                                                titleFont="subtitle",
        ...
        self._priorityDownStandFrame = EventFrame(self._scheduleFrame,
                                                  row = 4,
                                                  staticAppInfo=self._staticAppInfo,
                                                  root=root,
                                                  titleFont="subtitle",
        ...
        self._fillInDownStandFrame = EventFrame(self._scheduleFrame,
                                                row = 5,
                                                staticAppInfo=self._staticAppInfo,
                                                root=root,
                                                titleFont="subtitle",
        ...
        self._staticAppInfo.addEnterAndExit(name="Schedule Canvas",
    ...
    def openScheduleQuestionPopup(self):
        ...
        standDifferenceLabel = ttk.Label(self._questionPopupFrame,
        ...
        standDifferenceExplanation = ttk.Label(self._questionPopupFrame,
        ...
        invisibleSpacer4 = ttk.Label(self._questionPopupFrame,
                                     text="",
                                     background=self._staticAppInfo.getColor(self._frameDescriptor))
        invisibleSpacer4.grid(row=12, column=0, pady=5)

        #Create contact info label
        contactInfoLabel = ttk.Label(self._questionPopupFrame,
        ...
        #Contact info text
        contactInfoText = ttk.Label(self._questionPopupFrame,
        ...
        invisibleSpacer5 = ttk.Label(self._questionPopupFrame,
                                     text="",
                                     background=self._staticAppInfo.getColor(self._frameDescriptor))
        invisibleSpacer5.grid(row=15, column=0, pady=5)

        #Create contact info label
        brokenDefaultLabel = ttk.Label(self._questionPopupFrame,
        ...
        #Contact info text
        brokenDefaultText = ttk.Label(self._questionPopupFrame,
        ...
        self._staticAppInfo.addEnterAndExit(name="Schedule Question Canvas",
    ...
    def viewPopup(self):
        ...
        for key in standData:
            ...
            for stand in standData[key]:
                ...
                standInfo.append(ttk.Label(bottomFrame,
                                           text=message,
                                           foreground=self._staticAppInfo.getColor("subtext"),
                                           background=self._staticAppInfo.getColor(self._frameDescriptor),
                                           font=self._staticAppInfo.getFont("smallDefault"),
        ...
        #Set entry and exit data
        self._staticAppInfo.addEnterAndExit(name="Schedule View Canvas",
